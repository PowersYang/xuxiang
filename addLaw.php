		...
		<div id="text" align="left">
			<form action="lawService.php" method="post">
			     <table border='0' width="800px">
    			     <tr><td>新法标题：</td> <td align="left"><input type="text" name="title" size="50"/><td></tr>
    			     ...
    			     <tr><td>新法内容：</td> <td align="left">
                			        <script type="text/plain" id="myEditor" name="text" style="width:680px;height:230px;"></script>
    			                   </td>
    			     </tr>
