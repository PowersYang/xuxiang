		...
		<div id="text" align="left">
			<form action="caseService.php" method="post">
			     <table border='0' width="800px">
    			     <tr><td>案例标题：</td> <td align="left"><input type="text" name="title" size="50"/><td></tr>
    			     <tr><td>添加者：</td>  <td align="left"><?php echo $_SESSION['name']; ?></td></tr>
    			     <tr><td>案例内容：</td> <td align="left">
                			        <script type="text/plain" id="myEditor" name="text" style="width:680px;height:260px;"></script>
    			                   </td>
    			     </tr>
