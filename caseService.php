...
<?php 
    ...
    if($flag == "del"){
        ...
        if( $res==1 ){
            ...
            echo "<script> window.location='caseList.php?pageNow=1'; </script>";
        }
    }elseif ( $flag1 == "send" ){
        //说明要发布案例
        ...
        $sql = "insert into anli (title,zuozhe,text,time) value ('$title','$zuozhe','$text','$time')";
        	...
        	<div id="contentL">
           	...
           	<div id="contentR">
            	...
            	<div id="text" align="center">
           			<form action='caseService.php' method="post">
                         <table align="center" width="800px">
              			     <tr><td>案例标题：</td> <td><input type="text" name="title" size="50" value="<?php echo $row[0]['title']; ?>"></td></tr>
               			     <tr><td>修改者：</td>  <td><?php echo $_SESSION['name']; ?></td><input type="hidden" name="zuozhe" value="<?php echo $_SESSION['name']; ?>"></tr>
                    		 <tr><td>案例内容：</td> <td>
                    		             <script type="text/plain" id="myEditor" name="text" style="width:680px;height:290px;"><?php echo $row[0]['text']; ?></script></td>
                    		 </tr>	  		   	
                             <tr>
...
<?php
    ...
    if( $flag1 == "updateProcess" ){
        ...
        $sql = "update anli set title='$title', zuozhe='$zuozhe', text='$text', time='$time' where id=$id";
        $res = $sqlHelper->execute_dml($sql);
        if( $res==1 ){
            //说明修改成功
